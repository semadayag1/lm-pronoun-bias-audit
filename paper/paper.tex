...
The replication package is archived on Zenodo under the stable concept DOI \url{https://doi.org/10.5281/zenodo.20081530}. The GitHub repository is available at \url{https://github.com/semadayag1/lm-pronoun-bias-audit}. Inquiries regarding the dataset or pipeline may be directed to the corresponding author.
